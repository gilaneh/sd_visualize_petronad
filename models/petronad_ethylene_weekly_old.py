...
class SdVisualizePetronadCalculate(models.Model):
    ...
    def petronad_ethylene_weekly(self, diagram=0, update_date=0):
        ...
        # Production ##################################
        productions = self.env['km_petronad.production'].search([
                                                                 ('data_date', '>=', week_s_5),
                                                                 ('data_date', '<=', week_e_0), ]
        ...
        for rec in sorted_values:
            ...
            # storage_date
                ...
                value = self.convert_date(calendar, productions[0].data_date)
