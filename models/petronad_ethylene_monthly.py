...
class SdVisualizePetronadCalculate(models.Model):
    ...
    def petronad_ethylene_monthly(self, diagram=0, update_date=0):
        ...
        month_days_0 = ((date.today() if date.today() < month_e_0 else month_e_0 + timedelta(days=1)) - month_s_0).days
        month_days_0 = month_days_0 if month_days_0 > 0 else 0
        month_days_1 = ((date.today() if date.today() < month_e_1 else month_e_1 + timedelta(days=1)) - month_s_1).days
        month_days_1 = month_days_1 if month_days_1 > 0 else 0
        month_days_2 = ((date.today() if date.today() < month_e_2 else month_e_2 + timedelta(days=1)) - month_s_2).days
